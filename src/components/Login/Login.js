...
export class Login extends Component {
    ...
    render() {
        ...
        return (
            <Popup open={this.state.redirect} closeOnDocumentClick={false} modal> <a className="close" onClick={this.props.closeModal}>
            &times;
  </a>
            ...
            <form onSubmit={this.onSubmit} className="login-form">
                ...
                <div className="login-item">
                    ...
                    {/* <a href="@">שכחת סיסמה?</a> */}
                    {/*<a href="@">שכחת סיסמה?</a>*/}
                    <Link to="/signup" onClick={()=>this.props.closeModal()} >שכחת סיסמה?</Link>
