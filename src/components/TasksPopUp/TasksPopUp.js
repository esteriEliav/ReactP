...
export class TasksPopUp extends Component {
    ...
    componentDidMount = async() => {
       ...
       this.setState({timepassed: this.props.tasksList.filter(i=>new Date(i.DateForHandling) <new Date())}) 
       this.setState({urgent:this.props.tasksList.filter(i=>i.ClassificationID ===1)})
       this.setState({NotClassificated:this.props.tasksList.filter(i=>i.ClassificationID===null)})
